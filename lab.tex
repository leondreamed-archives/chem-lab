...
Then, the above mole ratio is used with the molar concentration formula to calculate the concentration of the \ce{KIO3} solution:
\begin{align*}
	c & = \frac{n}{V} \\
	c & = \frac{
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|}
		...
		\hline
		1 & 6.45                                                               & 0.0215\mpl\ ± 3\% \\ \hline
		2 & 6.25                                                               & 0.0208\mpl\ ± 3\% \\ \hline
	\end{tabular}
\end{table}
